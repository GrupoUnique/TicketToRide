        ...
        return(
            <View>
                ...
                >
                    ...
                    <Text style={styles.texto1}>Filtros</Text> 
                    <View style={styles.containersComponentes}>
                        <Text style={{alignSelf:'center', fontSize:14}}>Ida:</Text>
                        <PickerDate  style={{marginTop:15, alignSelf:'center'}} 
                            width={80} 
                            height={30} 
                            date={this.state.dateBegin} 
                            setDate={(dateBegin) => {this.setState({dateBegin:dateBegin});                                                                                                 this.setState({disableEnd:false})}} minDate={date.toString()} disabled={this.state.disableEnd}/>
                        <Text style={{alignSelf:'center'}}>Volta</Text>
                ...
                <View style={styles.containersComponentes}>
                    ...
                    <Text style={{fontSize:14 }}>Montanhas</Text>
                        <Switch  style={{alignSelf:'center'}} 
                            value={this.state.isMontanhas} 
                            onValueChange={() => {this.setState({isMontanhas:!this.state.isMontanhas}); 

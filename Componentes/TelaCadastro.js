    ...
    return(
            <ScrollView style={styles.containerPrincipal}> 
               <View style={styles.container}>
                ...
                <TextInput style={styles.input} placeholder={'Nome completo'} onSubmitEditing={() => this.EmailInput.focus()} onChangeText={(texto) => setNome(texto)}/>
                ...
                <TextInput style={styles.input} secureTextEntry placeholder={'Senha'} ref={(input) => this.SenhaInput = input} onChangeText={(texto) => setSenha(texto)}/>
                <TextInput style={styles.input} secureTextEntry placeholder={'Confirme sua senha'} ref={(input) => this.ConfirmaInput = input} onChangeText={(texto) => {if(texto === senha) console.log("Igual");}}/>

        ...
        <View style={{width:props.width,
            ...
            <View style={styles.ContencaoBig}>
                <Buttons 
                    width={'100%'} 
                    height={'100%'} 
                    imagem={require('../assets/festa.png')} 
                    color={'#ff63c4'} 
                    style={{marginTop:7}} 
                    text={'Baladas'} 
                    ImgWidth={45} 
            ...
            <View style={styles.ContencaoVerticais}>
                <View style={styles.ContencaoB1}>
                    <Buttons 
                        width={'49%'} 
                        height={'90%'} 
                        imagem={require('../assets/nature.png')} 
                        color={'#8fff40'} 
                        style={{marginTop:7}} 
                        text={'Natureza'} 
                        ImgWidth={35} 
                    ...
                    <Buttons 
                        width={'49%'} 
                        height={'90%'} 
                        imagem={require('../assets/snow.png')} 
                        color={'#69ebff'} 
                        style={{marginTop:7}} 
                        text={'Frio'} 
                        ImgWidth={30} 
                ...
                <View style={styles.ContencaoB2}>
                    <Buttons 
                        width={'49%'} 
                        height={'90%'} 
                        imagem={require('../assets/montanha.png')} 
                        color={'#ffaf24'} 
                        style={{marginTop:7}} 
                        text={'Montanha'} 
                        ImgWidth={25} 
                    ...
                    <Buttons 
                        width={'49%'} 
                        height={'90%'} 
                        imagem={require('../assets/umbrella.png')} 
                        color={'#ffef45'} 
                        style={{marginTop:7}} 
                        text={'Praias'} 
                        ImgWidth={30} 
